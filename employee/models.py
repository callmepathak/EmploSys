...
class EmployeeDetail(models.Model):
      ...
      def __str__(self): #It should be used to return a name for an object created using a particular model class
          return self.user.username

class EmployeeEducation(models.Model): #make the  EmployeeEducation class inherit from the Model base class from the models module.
      user = models.ForeignKey(User,on_delete=models.CASCADE)
